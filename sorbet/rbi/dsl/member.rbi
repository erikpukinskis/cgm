...
class Member
  ...
  sig { params(unencrypted_password: T.untyped).returns(T.any(Member, FalseClass)) }
  ...
  module CommonRelationMethods
    ...
    sig { params(block: T.nilable(T.proc.params(object: ::Member).void)).returns(::Member) }
    sig do
      params(
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Member).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Member` class because it declared `has_many :measurements`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Measurement::PrivateCollectionProxy) }
    def measurements; end

    sig { params(value: T::Enumerable[::Measurement]).void }
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::Member).returns(BasicObject)).returns(T::Array[::Member]) }
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_email_confirmed_at?; end
